...
(function() {
  ...
  Frame = (function() {
    ...
    Frame.prototype.toString = function() {
      ...
      if (this.body) {
        lines.push("Computed content-length:" + ('' + this.body).length);
      }
  ...
  Client = (function() {
    ...
    Client.prototype.connect = function(login, passcode, connectCallback, errorCallback, vhost) {
      ...
      this.ws.onmessage = function(evt) {
        ...
        if (typeof _this.debug === "function") {
          _this.debug("<<< I'm receiving from the websocket connection:" + data + " The end of data");
        }
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          switch (frame.command) {
            ...
            case "MESSAGE":
              ...
              //ADDED here so to implicitely allow the next MESSAGE to be received
              _this.ack(frame.headers['message-id'],frame.headers.subscription); 
    ...
    Client.prototype.subscribe = function(destination, callback, headers) {
      if (headers == null) {
        headers = {};
        //ADDED here to allow the client to let the broker knows when it can send next message out of the destinaion
        headers.ack="client"; // STILL means we must send an ACK at end of reception/treatment of a MESSAGE
        //headers.selector="typemessage = 'step'"; //If you want to filter out which messages you are interested, put the selector 
      }
      if (!headers.id) {
